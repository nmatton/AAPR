...
export const AvailablePracticesMethodFilter = () => {
  const { availableMethods, selectedMethods, toggleMethod } = useAddPracticesStore()

  const methods = Array.from(new Set([...availableMethods, ...selectedMethods])).sort((a, b) =>
    a.localeCompare(b)
  )

                        ...
                        <div className="flex flex-wrap">
                            {practice.pillars && practice.pillars.length > 0 ? (
                                practice.pillars.map(p => (
                                    <span key={p.id} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mr-2 mb-2 bg-indigo-50 text-indigo-700 border border-indigo-100">
                                        {p.name}
                                    </span>
                                ))
                            ) : (

...
export const PracticeCatalogDetail = ({ practice, onClose }: PracticeCatalogDetailProps) => (
  <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-end z-40" role="dialog" aria-modal="true">
    <div className="w-full max-w-md h-full bg-white shadow-xl overflow-y-auto transform transition-transform translate-x-0">
